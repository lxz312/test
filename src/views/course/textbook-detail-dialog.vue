      ...
      <el-row :gutter="18">
        <el-col :span="18">
          <el-form-item label="教材使用状态">
            <el-select
              v-model="value.data.textbookUseStatus"
              placeholder="请选择教材使用状态"
              :value="value.data.textbookUseStatus"
            >
      ...
      <el-row :gutter="18">
        <el-col :span="18">
          <el-form-item label="教材选用类别">
            <el-select
              v-model="value.data.textbookSelectType"
              placeholder="请选择教材选用类别"
              :value="value.data.textbookSelectType"
            >
      ...
      <el-row :gutter="18">
        <el-col :span="18">
          <el-form-item label="教材类型">
            <el-select
              v-model="value.data.textbookType"
              placeholder="请选择教材类型"
              :value="value.data.textbookType"
            >
...
import { addTextbook, updateTextbook } from "@/api/course";
  ...
  methods: {
    ...
    update() {
      this.$refs.courseForm.validate((valid) => {
        if (valid) {
          this.btnLoading = true;
          updateTextbook(this.value.data)
            .then(() => {
