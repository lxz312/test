  ...
  <div>
    <el-dialog title="课程详情" :visible.sync="value.show" @open="onOpen">
      ...
      >
        ...
        >添加教材</el-button>
        <el-table v-else :data="textbookList" border fit highlight-current-row>
        ...
        <template slot-scope="scope">
          ...
          <el-table-column label="管理" align="center" width="200">
            <template slot-scope="scope">
              <el-button type="info" size="mini" @click.native.prevent="showDetail(scope.$index)">查看</el-button>
              <el-button
                type="danger"
                size="mini"
...
export default {
  ...
  methods: {
    ...
    onOpen() {
      ...
      getTextbook(this.value.data.courseId)
        .then((response) => {
