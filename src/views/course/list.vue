<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="国家课程代码" align="center" prop="nationalCourseId" width="120" />
      <el-table-column label="课程名" align="center" prop="courseName" width="120" />
      <el-table-column label="课程说明" align="center" prop="courseSpecification" width="120" />
      <el-table-column label="课程性质" align="center" prop="courseProperty" width="120" />
      <el-table-column
        label="课程状态"
        align="center"
        prop="courseStatus"
