<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="课程编码" align="center" prop="textbookCode" width="120" />
      <el-table-column label="教材名称" align="center" prop="textbookName" width="120" />
      <el-table-column label="作者" align="center" prop="author" width="120" />
      <el-table-column label="单价" align="center" prop="price" width="120" />
      <el-table-column label="选用类型" align="center" prop="textbookSelectType" width="120" />
      <el-table-column label="教材状态" align="center" prop="textbookUseStatus" width="120">
        <template slot-scope="scope">
          <el-tag
            :type="scope.row.textbookUseStatus === '在用' ? 'success' : (scope.row.textbookUseStatus === '未启用' ? 'warning' : 'danger')"
            disable-transitions
          >{{scope.row.textbookUseStatus}}</el-tag>
        </template>
      </el-table-column>
...
<script>
import { listTextbook, removeTextbook } from "@/api/course";
