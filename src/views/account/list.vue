<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="邮箱" align="center" prop="email" width="280" />
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="密码" prop="password" required v-if="dialogStatus !== 'updateRole'">
          <el-input
            type="password"
            prefix-icon="el-icon-edit"
            auto-complete="off"
        ...
        <el-form-item label="角色" v-if="dialogStatus === 'updateRole'">
