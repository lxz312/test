<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="考次" align="center" prop="exams_id" width="150" />
      <el-table-column sortable label="考试日期" align="center" prop="exam_date" width="150" />
      <el-table-column sortable label="考试类型" align="center" prop="exams_type" width="150" />
      <el-table-column
        label="管理"
        align="center"
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="考试日期" prop="exam_date" v-if="operationStatus === 'batch'">
          <el-date-picker v-model="tmpData.exam_date" type="date" placeholder="考试日期"></el-date-picker>
        </el-form-item>
        <el-form-item label="考试日期" prop="exam_date" v-else required>
          <el-date-picker v-model="tmpData.exam_date" type="date" placeholder="考试日期"></el-date-picker>
        </el-form-item>
        <el-form-item label="时间编码" prop="time_id" v-if="operationStatus === 'batch'">
          <el-input type="text" auto-complete="off" v-model="tmpData.time_id" />
        </el-form-item>
        ...
        <el-form-item label="统考课程默认收费" prop="default_charge">
          <el-input type="number" auto-complete="off" v-model="tmpData.default_charge" />
        </el-form-item>
        <el-form-item label="照相收费" prop="photo_charge">
          <el-input type="number" auto-complete="off" v-model="tmpData.photo_charge" />
        </el-form-item>
