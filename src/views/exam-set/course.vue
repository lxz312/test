    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        <el-form-item label="考次编码" prop="exam_id" required>
          <el-input type="text" auto-complete="off" v-model="tmpData.exam_id" />
        </el-form-item>
        <el-form-item label="课程编码" prop="course_id" required>
          <el-input type="text" auto-complete="off" v-model="tmpData.course_id" />
        </el-form-item>
...
import {
  courseList as list,
  courseSearch as search,
  courseRemove as remove,
  courseAdd as add,
  courseUpdate as update,
  courseAddByBatch,
} from "@/api/exam-set";
