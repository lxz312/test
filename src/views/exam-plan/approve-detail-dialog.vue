      ...
      <el-row :gutter="18">
        <el-col :span="18">
          <el-form-item label="考试计划审批状态" prop="examApproveStatus">
            <el-select
              v-model="value.data.examApproveStatus"
              placeholder="请选择考试计划审批状态"
              :value="value.data.examApproveStatus"
            >
...
import { addApprove, updateApprove } from "@/api/exam-plan";
