...
<template>
  <div class="app-container">
    <div class="filter-container">
      <el-form :inline="true">
        <el-form-item>
          ...
          <el-button size="mini" v-if="hasPermission('role:delete')" @click="$router.back(-1)">返回</el-button>
        </el-form-item>
      </el-form>
    </div>
    <el-table
    ...
    >
      ...
      <el-table-column label="管理" align="center" v-if="hasPermission('role:update')">
        <template slot-scope="scope">
          <el-button
            type="primary"
            size="mini"
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        <el-form-item label="课程编码" prop="new_course_id">
          <el-input type="text" auto-complete="off" v-model="approveCourseData.new_course_id" />
        </el-form-item>
        <el-form-item label="课程名称" prop="new_course_name">
          <el-input type="text" auto-complete="off" v-model="approveCourseData.new_course_name" />
        </el-form-item>
      </el-form>
...
import {
  getApproveCourseDataList,
  AddApproveCourseData,
  removeData,
} from "@/api/approve_course";
...
export default {
  ...
  methods: {
    ...
    getApproveCourseDataList(id) {
      ...
      getApproveCourseDataList(id)
        .then((response) => {
          ...
          console.log(
            "approveCourseDataList" + JSON.stringify(approveCourseDataList)
          );
        })
        .catch((res) => {});
    },
    ...
    AddApproveCourseData() {
      ...
      AddApproveCourseData(this.approveCourseDataSet, this.Datafrom.schoolId)
        .then(() => {
