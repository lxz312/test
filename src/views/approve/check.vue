          ...
          <el-row :gutter="18">
            <el-col :span="12">
              <el-form-item label="专业名称">
                <el-input v-model="ApproveNewData.major_name" :disabled="true"/>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="总学分">
                <el-input v-model="ApproveNewData.total_credit" type="number" :disabled="true"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="18">
          ...
          <el-row :gutter="18">
            <el-col :span="12">
              <el-form-item label="毕业学分">
                <el-input v-model="ApproveNewData.graduation_credit" type="number" :disabled="true"/>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="总课程数">
                <el-input v-model="ApproveNewData.total_course_number" type="number" :disabled="true"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="18">
            ...
            <el-col :span="12">
              <el-form-item label="专业大类级别">
                <el-input v-model="ApproveNewData.major_category_level" :disabled="true"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="18">
            <el-col :span="12">
              <el-form-item label="专业大类代码" prop="major_category_code">
                <el-input v-model="ApproveNewData.major_category_code" :disabled="true"/>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="专业大类名称">
                <el-input v-model="ApproveNewData.major_category_name" :disabled="true"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="18">
