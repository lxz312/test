<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      >
        ...
        <el-row :gutter="18">
          <el-col :span="12">
            <el-form-item label="专业名称">
              <el-input v-model="tmpData.major_name" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row :gutter="18">
          <el-col :span="8">
            <el-form-item label="专业类型">
              <el-select
                v-model="tmpData.major_type"
                placeholder="请选择专业类型"
                :value="tmpData.major_type"
              >
          ...
          <el-col :span="8">
            <el-form-item label="开考形式">
              <el-select
                v-model="tmpData.exam_type"
                placeholder="请选择开考形式"
                :value="tmpData.exam_type"
              >
        ...
        <el-row :gutter="18">
          ...
          <el-col :span="12">
            <el-form-item label="专业大类级别">
              <el-input v-model="tmpData.major_category_level" :disabled="true" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="18">
          <el-col :span="12">
            <el-form-item label="专业大类代码" prop="major_category_code">
              <el-input v-model="tmpData.major_category_code" @focus="getCategoryMajorList" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="专业大类名称">
              <el-input v-model="tmpData.major_category_name" :disabled="true" />
            </el-form-item>
          </el-col>
        </el-row>
      ...
      <el-row>
        <el-col :margin-left="24">
          <div class="grid-content bg-purple-dark">
            ...
            <el-button type="success" :loading="btnLoading" @click.native.prevent="addMajor">添加</el-button>
          </div>
        </el-col>
      </el-row>
    </div>
    ...
    <el-dialog :visible.sync="dialogFormVisible" v-if="operationStatus === 'nation'">
      <el-table :data="nationDataList" highlight-current-row>
    ...
    <el-dialog :visible.sync="dialogFormVisible" v-if="operationStatus === 'category'">
      <el-table :data="categoryDataList" highlight-current-row>
...
export default {
  ...
  methods: {
    ...
    dataCheck() {
      ...
      this.tmpData.major_id = "A000001";
      this.tmpData.national_major_code = "M000001";
      this.tmpData.major_name = "专业";
      this.tmpData.major_brief_introduction = "无";
      this.tmpData.major_type = "本科段";
      this.tmpData.education_level = "本科";
      this.tmpData.exam_type = "面向高校";
      this.tmpData.main_target_school = "北京大学";
      ...
      this.tmpData.major_category_code = "A000001";
      this.tmpData.apply_condition = "无";
      this.tmpData.graduation_condition = "无";
      this.tmpData.notes = "无";
    },
    ...
    addMajor() {
      ...
      addApproveMajor(this.tmpData, this.school_id)
        .then(() => {
          this.$message.success("成功");
