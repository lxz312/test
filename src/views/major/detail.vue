        ...
        <el-row :gutter="18">
          ...
          <el-col :span="12">
            <el-form-item label="专业简介">
              <el-input v-model="tmpData.major_brief_introduction"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="18">
        ...
        <el-row :gutter="18">
          <el-col :span="12">
            <el-form-item label="首次开考考次" prop="first_exam_id">
              <el-input v-model="tmpData.first_exam_id"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row :gutter="18">
          <el-col :span="12">
            <el-form-item label="停止新生注册考次" prop="stop_freshman_registration_exam_id">
              <el-input v-model="tmpData.stop_freshman_registration_exam_id"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row :gutter="18">
          <el-col :span="12">
            <el-form-item label="停止报考考次" prop="stop_apply_exam_id">
              <el-input v-model="tmpData.stop_apply_exam_id"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
