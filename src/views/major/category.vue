    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="名称" prop="major_category_name" required>
          <el-input type="text" auto-complete="off" v-model="tmpData.major_category_name" />
        </el-form-item>
...
import {
  ...
  categorySearch as search,
  categoryRemove as remove,
  categoryAdd as add,
  categoryUpdate as update,
} from "@/api/major";
