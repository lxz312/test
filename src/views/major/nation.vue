<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="专业全国编码" align="center" prop="national_major_code" width="150" />
      <el-table-column label="名称" align="center" prop="major_name" width="150" />
      <!-- <el-table-column label="简称" align="center" prop="major_abbr" width="200" /> -->
      <el-table-column label="学历层次" align="center" prop="education_level" width="150" />
      <el-table-column sortable label="学分" align="center" prop="credit" width="150" />
      <el-table-column
        label="管理"
        align="center"
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="名称" prop="major_name" required>
          <el-input type="text" auto-complete="off" v-model="tmpData.major_name" />
        </el-form-item>
        <el-form-item label="简称" prop="major_abbr">
          <el-input type="text" auto-complete="off" v-model="tmpData.major_abbr" />
        </el-form-item>
        ...
        <el-form-item label="学分" prop="credit" required>
          <el-input type="number" v-model="tmpData.credit" />
        </el-form-item>
      </el-form>
...
import {
  nationList as list,
  nationSearch as search,
  nationRemove as remove,
  nationAdd as add,
  nationUpdate as update,
} from "@/api/major";
